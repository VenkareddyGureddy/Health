                        ...
                        >
                            ...
                            <div className="flex justify-between items-center border rounded-lg px-4 py-3">
                                ...
                                <button
                                    ...
                                    className={`h-6 w-11 rounded-full transition ${requireApproval ? "bg-teal-600" : "bg-gray-300"
                                        }`}
                                >
                                    <span
                                        className={`block h-5 w-5 bg-white rounded-full transition ${requireApproval ? "translate-x-5" : "translate-x-1"
                                            }`}
                                    />
                                </button>
                            </div>
