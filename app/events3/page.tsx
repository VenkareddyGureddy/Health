          ...
          <div className="md:col-span-2 space-y-6 sm:space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 p-4 sm:p-5 border rounded-xl bg-white shadow-sm">
              ...
              <div className="text-center sm:text-left">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  Renowned cardiologist specializing in heart attack prevention,
                  early detection, and emergency cardiac care.
                </p>
              </div>
            </div>
            ...
            <section>
              ...
              <p className="text-gray-600">
                This virtual awareness session focuses on understanding heart
                attacks, recognizing early warning signs, managing risk factors,
                and taking immediate action to save lives.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="space-y-3 text-gray-600">
                {[
                  "Learn early symptoms and warning signs of heart attacks",
                  "Understand lifestyle and medical risk factors",
                  "Gain expert guidance on emergency response and prevention",
                ].map((text) => (
